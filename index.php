<?php
    $data = [
        ...
        [
            ...
            <br><br>
            If the country associated with your account doesn’t correspond to your country of residence, it could be because of a difference between your country of work and residence, because you’ve installed a Virtual Private Network (VPN) to mask your IP address, or because you live close to a territorial border. <a href='https://support.google.com/accounts/troubleshooter/10082950?p=country_association&al=Italy&visit_id=637583004638775847-1724207322&rd=2'>Contact us</a> if you think your country association is wrong."
...
<body>
    <header>
        <div>
            <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="" style="vertical-align: middle;margin-left: 15px;">
            <span style="color: gray; font-size: 1.5em; font-weight:500; vertical-align: middle;">Privacy & Terms</span>
        </div>
